...
public class Entity {
	//une entité charge sur un terrain (cela nous permet notamment de supprimer notre entité plus simplement)
	Field field;
	//une entité se situe dans un contexte graphique (contexte de notre Canvas -- field)
	GraphicsContext gc;
	...
	public void display()
	  {
		  ...
		  //gc.drawImage(new Image("assets/boule.png"), this.position.x, this.position.y);
